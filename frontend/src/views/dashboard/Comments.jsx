              ...
              <div className="bg-white shadow rounded-md">
                <div className="border-b border-gray-200 p-4 flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">You have full control to manage your own comments.</p>
                  </div>
                </div>
                <div className="p-4">
                  <ul className="space-y-4">
                    {comments?.map((c) => (
                      <li key={c.id} className="bg-gray-50 shadow rounded-md p-4">
                        <div className="flex">
                          ...
                          <div className="ml-4 flex-1">
                            ...
                            <p className="mt-2">
                              <span className="font-semibold">Comment:</span> {c.comment}
                            </p>
                            <p className="mt-2">
                              <span className="font-semibold">Response:</span> {c.reply || <span className="text-red-500">No Reply</span>}
                            </p>
                            <button
                            ...
                            >
                              {expandedComment === c.id ? "Hide Response" : "Send Response"}
                            </button>
