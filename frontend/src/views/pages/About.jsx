        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-8">
              At <span className="font-bold text-gray-800">BlogSphere</span>, we
              believe in the power of words and stories. Our platform is where
              creativity meets curiosity, providing a space for writers,
              creators, and readers to explore, share, and connect. From expert
              insights to personal journeys, our mission is to create a hub for
